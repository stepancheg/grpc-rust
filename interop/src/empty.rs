...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x04\x1e\0*\x10\n\xe7\x0b\n\x01\x0c\x12\x03\x1e\0\x122\xdc\x0b\x20Co\
    pyright\x202015,\x20Google\x20Inc.\n\x20All\x20rights\x20reserved.\n\n\
    ...
    AMAGE.\n\n\x08\n\x01\x02\x12\x03\x20\x08\x14\n\xad\x02\n\x02\x04\0\x12\
    \x03*\0\x10\x1a\xa1\x02\x20An\x20empty\x20message\x20that\x20you\x20can\
    \x20re-use\x20to\x20avoid\x20defining\x20duplicated\x20empty\n\x20messag\
    es\x20in\x20your\x20project.\x20A\x20typical\x20example\x20is\x20to\x20u\
    se\x20it\x20as\x20argument\x20or\x20the\n\x20return\x20value\x20of\x20a\
    \x20service\x20API.\x20For\x20instance:\n\n\x20\x20\x20service\x20Foo\
    \x20{\n\x20\x20\x20\x20\x20rpc\x20Bar\x20(grpc.testing.Empty)\x20returns\
    \x20(grpc.testing.Empty)\x20{\x20};\n\x20\x20\x20};\n\n\n\n\n\x03\x04\0\
    \x01\x12\x03*\x08\rb\x06proto3\
";
